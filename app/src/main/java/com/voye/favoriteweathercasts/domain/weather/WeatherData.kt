...
data class WeatherData(
    ...
    val current: com.voye.favoriteweathercasts.domain.weather.Current,

    val hourly: List<com.voye.favoriteweathercasts.domain.weather.Hourly>,

    val daily: List<com.voye.favoriteweathercasts.domain.weather.Daily>
